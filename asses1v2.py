...
def main():
    ...
    gcItemsLstDesc = []  # creates the initial list for the description of the gift card purchase
    gcItemsLstCost = []  # creates the initial list for the cost of the gift card purchases
    #gcCostRunningTotal = []
    #retrys = 0
