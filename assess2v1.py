...
Auth ID: 3374690
Date: Start -> 09/3422 Upload -> 29/04/22
...
class MainMenu:
    ...
    def gift_card(self):
        ...
        gc_name = self.gc_name_used(gc_name)  # runs gc_name_used method with gc_name as the argument
        # gc_name_used is used to determine if gift card name has been used, gc_name will be reassigned if taken
